...
This model's balanced accuracy for training data and validation data are 0.29 and 0.30, showing that there is no overfitting in neural model. Finally, the balanced accuracy for test data is 0.347 and combined with confusion matrix, we can figure some summary.
