...
To apply support vector machines technique to predict the grouped categories of Amyl nitrite usage, various kernels (polynomial with degrees 3, radial basis function, and sigmoid respectively) are employed to train 5 distinct SVM models.
